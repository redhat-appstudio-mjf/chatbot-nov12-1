...
2) Go to the `Data Science Projects` section and access your application's project named `chatbot-nov12-1`.

![image](./images/data-science-projects.png)

3) Access the `workbench` named `chatbot-nov12-1-notebook`.
...
5) In the terminal, run `cd chatbot-nov12-1` to navigate to your sample app's directory.
